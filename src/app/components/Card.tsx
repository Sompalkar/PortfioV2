...
//Three.js with meshline components
...
// Extra Var Rigid body to include additional properties
...
function Band({
  ...
  // Using longer rope distances to reduce tension
  ...
  // Using debounce mechanism to reduce excessive physics updates
  ...
  useFrame((state, delta) => {
    ...
    // Handling dragging with smoother transitions
    ...
    if (fixed.current && band.current) {
      ...
      [j1, j2].forEach((ref) => {
        ...
        if (rigidBody) {
          ...
          // Added more gradual lerping for smoother movement
      ...
      if (j3.current && j2.current && j1.current) {
        ...
        // Increased point count for smooth curve
