...
function Header() {
  ...
  // Adding  effect to handle theme transition

  useEffect(() => {

    // Adding transition class to body when component mounts
  ...
  // adding the Transition class before theme chnage and removing it after
    ...
    <div>
      <div className="flex justify-between items-center p-3 bg-background w-full z-20">
        <div className="flex items-center">
          <div className="text-base text-[var(--primary)]">Som Palkar</div>
        </div>
